...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 11, 2018 at 09:01 AM
...
INSERT INTO `answers` (`answer_id`, `answer`, `question_id`, `letter`) VALUES
(1, 'Cache-Control', 1, ''),
(2, 'Connection', 2, ''),
(3, 'Upgrade', 1, ''),
(4, 'Accept', 1, ''),
...
(88, 'Abstract', 19, ''),
(89, 'Boolean', 19, ''),
(90, 'Hakom Wiun Lie and Bert Bos', 28, 'A'),
(91, '500', 25, 'B'),
(92, 'Brendan Eich', 26, 'C'),
(93, '404', 23, 'D'),
(94, 'DOM Exception', 27, 'E'),
(95, '403', 24, 'F'),
(96, 'Host', 29, 'G'),
(97, '304', 21, 'H'),
(98, '200', 22, 'I'),
...
(31, 'Maybe be a domain name or an IP address', 'identification', 100, NULL),
(32, 'Who developed javascript?', 'identification', 101, NULL),
(33, 'Primary consists of web browsers, but also includes web crawlers/spiders, web-based, email clients, web-based end user tools and applications, etc', 'identification', 102, NULL),
(34, 'A global information medium which users can read and write via computers connected to the internet', 'identification', 103, NULL),
(35, 'What is T is in the IETF?', 'identification', 104, NULL),
(36, 'Set of rules need to be followed', 'identification', 105, NULL),
(37, 'What is the R in the RFC?', 'identification', 106, NULL),
(38, 'Indicates that the request has been received, and the process is being continued', 'identification', 107, NULL),
(39, 'Indicates that further action must be taken in order to complete the request', 'identification', 108, NULL),
(40, 'Request the server to \"echo\" back to the client the received request', 'identification', 109, NULL);
