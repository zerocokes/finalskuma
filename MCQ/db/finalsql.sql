...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 06, 2018 at 03:16 AM
...
(2, '2. Which of the following do NOT belong to the request header fields?', 'mulltiple_choice', NULL),
(3, '3.Which of the following do NOT belong to the response header fields?', 'mulltiple_choice', NULL),
(4, '4. Which of the following do NOT belong to the entity header fields?', 'mulltiple_choice', NULL),
(5, '5. Which of the following do NOT belong to the DOM object?', 'mulltiple_choice', NULL),
(6, '6. Who is the father of the web?', 'mulltiple_choice', NULL),
(7, '7. The following is the basic differences of XHTML to HTML except for?', 'mulltiple_choice', NULL),
(8, '8. In the HSL Value, the 120 degree is what color?', 'mulltiple_choice', NULL),
(9, '9. In the HSL value, the 240 degree is what color?', 'mulltiple_choice', NULL),
(10, '10. In the HSL Value, the 0 degree is what color?', 'mulltiple_choice', NULL);
